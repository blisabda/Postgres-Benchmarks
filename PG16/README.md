# PostgreSQL 16 Performance Research: Docker vs Kubernetes

This project benchmarks PostgreSQL 16 performance across different resource configurations in both Docker containers and Kubernetes pods.
